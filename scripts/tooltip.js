...
config. BgColor 		= '#dedede' // Background colour (HTML colour value, in quotes)
...
config. Duration		= 7000 		// Time span in ms after which the tooltip disappears; 0 for infinite duration, < 0 for delay in ms _after_ the onmouseout until the tooltip disappears
