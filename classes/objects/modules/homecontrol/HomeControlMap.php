...
class HomeControlMap extends Object{
  ...
  public static $LAYOUTART_DESKTOP = "DESKTOP";
  ...
  function handleControlEdit($dbTable){
    ...
    if ($_SESSION['aktEtage'] && isset($_REQUEST['Name']) && isset($_REQUEST['FunkId']) && isset($_REQUEST['Art']) ) {
...
echo "Layout-Art: " .$this->LAYOUT_ART ."<br>";
